...
LIFTimeDrivenModel::LIFTimeDrivenModel()
...
std::map<std::string, boost::any> LIFTimeDrivenModel::GetSpecificNeuronParameters(int index) const noexcept(false)
{
	return GetParameters();
}

void LIFTimeDrivenModel::SetParameters(std::map<std::string, boost::any> param_map) noexcept(false)
{
...
IntegrationMethod *LIFTimeDrivenModel::CreateIntegrationMethod(ModelDescription imethodDescription) noexcept(false)
{
...
ModelDescription LIFTimeDrivenModel::ParseNeuronModel(std::string FileName) noexcept(false)
{
	FILE *fh;
