...
void CompressSynchronousTableBasedModel::LoadNeuronModel(string ConfigFile) noexcept(false){
	FILE *fh;
	long Currentline = 0L;
...
void CompressSynchronousTableBasedModel::LoadNeuronModel() noexcept(false){
...
std::map<std::string, boost::any> CompressSynchronousTableBasedModel::GetSpecificNeuronParameters(int index) const noexcept(false){
	return GetParameters();
}

void CompressSynchronousTableBasedModel::SetParameters(std::map<std::string, boost::any> param_map) noexcept(false){
...
ModelDescription CompressSynchronousTableBasedModel::ParseNeuronModel(std::string FileName) noexcept(false){
