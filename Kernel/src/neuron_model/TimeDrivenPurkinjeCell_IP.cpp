...
std::map<std::string, boost::any> TimeDrivenPurkinjeCell_IP::GetSpecificNeuronParameters(int index) const noexcept(false){
	return GetParameters();
}

void TimeDrivenPurkinjeCell_IP::SetParameters(std::map<std::string, boost::any> param_map) noexcept(false){
...
IntegrationMethod * TimeDrivenPurkinjeCell_IP::CreateIntegrationMethod(ModelDescription imethodDescription) noexcept(false){
...
ModelDescription TimeDrivenPurkinjeCell_IP::ParseNeuronModel(std::string FileName) noexcept(false){
	FILE *fh;
