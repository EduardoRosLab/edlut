...
std::vector<std::string> NeuronModelFactory::GetAvailableNeuronModels(){
  ...
  availableNeuronModels.push_back(ALIFTimeDrivenModel::GetName());
...
void NeuronModelFactory::InitializeNeuronModelFactory(){
    ...
    NeuronModelFactory::NeuronModelMap[ALIFTimeDrivenModel::GetName()] =
			NeuronModelFactory::NeuronModelClass(
				ALIFTimeDrivenModel::ParseNeuronModel,
				ALIFTimeDrivenModel::CreateNeuronModel,
				ALIFTimeDrivenModel::GetDefaultParameters,
				ALIFTimeDrivenModel::GetNeuronModelInfo);
