...
#ifndef WITHPOSTANDTRIGGERSYNAPTIC_H_
#define WITHPOSTANDTRIGGERSYNAPTIC_H_



/*!
 * \file WithPostAndTriggerSynaptic.h
 *
...
/*!
 * \class WithPostAndTriggerSynaptic
 *
 * \brief Learning rule.
 *
 * This class abstract the behaviour of a learning rule that does implement postsynaptic and trigger learning.
 *
 * \author Francisco Naveros
 * \date February 2023
 */
class WithPostAndTriggerSynaptic : public LearningRule {
	...
	public:
		 ...
		 */
		virtual ~WithPostAndTriggerSynaptic();
...
#endif /* WITHPOSTANDTRIGGERSYNAPTIC_H_ */
