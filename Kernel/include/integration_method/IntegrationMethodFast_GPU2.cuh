/***************************************************************************
 *                           IntegrationMethodFast_GPU2.cuh                *
 *                           -------------------                           *
...
#ifndef INTEGRATIONMETHODFAST_GPU2_H_
#define INTEGRATIONMETHODFAST_GPU2_H_

/*!
 * \file IntegrationMethodFast_GPU2.cuh
 *
...
/*!
 * \class IntegrationMethodFast_GPU2
 *
 * \brief Integration method Fast in a GPU.
 *
...
class IntegrationMethodFast_GPU2 : public IntegrationMethod_GPU2 {
	public:
		...
		*
		* It generates a new IntegrationMethodFast object in GPU memory.
		*
		...
		*/
		__device__ IntegrationMethodFast_GPU2(Neuron_Model_GPU2* NewModel, void ** Buffer_GPU) : IntegrationMethod_GPU2(Buffer_GPU, NewModel->time_scale), neuron_model(NewModel){
		}
		 ...
		 */
		__device__ virtual ~IntegrationMethodFast_GPU2(){
		}
...
#endif /* INTEGRATIONMETHODFAST_GPU2_H_ */
