...
class RK4_GPU2 : public FixedStep_GPU2<Neuron_Model_GPU2> {
	public:
		...
		*/
		 ...
		 */
		__device__ RK4_GPU2(Neuron_Model_GPU2* NewModel, void ** Buffer_GPU) :FixedStep_GPU2<Neuron_Model_GPU2>(NewModel, Buffer_GPU){
		...
		*/
		__device__ virtual void NextDifferentialEquationValues(int index, int SizeStates, float * NeuronState){
			...
			this->neuron_model->EvaluateTimeDependentEquation(offset2, offset1, AuxNeuronState, this->elapsedTimeInNeuronModelScale*0.5f, 0);
			this->neuron_model->EvaluateDifferentialEquation(offset2, offset1, AuxNeuronState, AuxNeuronState2, this->elapsedTimeInNeuronModelScale);
			...
			this->neuron_model->EvaluateDifferentialEquation(offset2, offset1, AuxNeuronState, AuxNeuronState3, this->elapsedTimeInNeuronModelScale);
			...
			this->neuron_model->EvaluateTimeDependentEquation(offset2, offset1, AuxNeuronState, this->elapsedTimeInNeuronModelScale*0.5f, 0);
			this->neuron_model->EvaluateDifferentialEquation(offset2, offset1, AuxNeuronState, AuxNeuronState4, this->elapsedTimeInNeuronModelScale);
