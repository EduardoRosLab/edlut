...
class Bifixed_RK4_GPU2 : public BifixedStep_GPU2<Neuron_Model_GPU2> {
	public:
		...
		*/
		__device__ Bifixed_RK4_GPU2(Neuron_Model_GPU2* NewModel, void ** Buffer_GPU):BifixedStep_GPU2<Neuron_Model_GPU2>(NewModel, Buffer_GPU){
		...
		__device__ virtual void NextDifferentialEquationValues(int index, int SizeStates, float * NeuronState){
			...
			for(int iteration=0; iteration<this->N_BifixedSteps; iteration++){
				...
				this->neuron_model->EvaluateTimeDependentEquation(offset2, offset1, AuxNeuronState, this->BifixedElapsedTimeInNeuronModelScale*0.5f, 0);
				this->neuron_model->EvaluateDifferentialEquation(offset2, offset1, AuxNeuronState, AuxNeuronState2, this->BifixedElapsedTimeInNeuronModelScale);
				...
				this->neuron_model->EvaluateDifferentialEquation(offset2, offset1, AuxNeuronState, AuxNeuronState3, this->BifixedElapsedTimeInNeuronModelScale);
				...
				this->neuron_model->EvaluateTimeDependentEquation(offset2, offset1, AuxNeuronState, this->BifixedElapsedTimeInNeuronModelScale*0.5f, 0);
				this->neuron_model->EvaluateDifferentialEquation(offset2, offset1, AuxNeuronState, AuxNeuronState4, this->BifixedElapsedTimeInNeuronModelScale);
