...
class Euler_GPU2 : public FixedStep_GPU2<Neuron_Model_GPU2> {
	public:
		...
		*
		* It generates a new Euler Integration Method object in GPU memory.
		*
		...
		*/
		__device__ Euler_GPU2(Neuron_Model_GPU2* NewModel, void ** Buffer_GPU) :FixedStep_GPU2<Neuron_Model_GPU2>(NewModel, Buffer_GPU){
