...
#ifndef VARIABLESTEP_H_
#define VARIABLESTEP_H_
 ...
 * \date May 2013
 *
 * This file declares a class which abstracts all variable step integration methods in CPU.
 */
 ...
 * \class VariableStep
 *
 * \brief Variable stpe integration methods
 *
 * This class abstracts the behavior of Euler integration method for neurons in a 
 ...
 * \date April 2013
 */
class VariableStep : public IntegrationMethod {
	protected:
	...
	public:
		 ...
		 *
		 * It generates a new VariableStep object.
		 *
		 ...
		 */
		VariableStep(TimeDrivenNeuronModel * NewModel, string integrationMethodType, int N_neuronStateVariables, int N_differentialNeuronState, int N_timeDependentNeuronState, bool jacobian, bool inverse);
