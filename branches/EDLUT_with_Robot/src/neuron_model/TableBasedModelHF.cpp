...
void TableBasedModelHF::LoadNeuronModel(string ConfigFile) throw (EDLUTFileException){
	FILE *fh;
	long Currentline = 0L;
...
void TableBasedModelHF::LoadTables(string TableFile) throw (EDLUTException){
	FILE *fd;
	unsigned int i;
...
void TableBasedModelHF::UpdateState(int index, VectorNeuronState * State, double CurrentTime){
...
void TableBasedModelHF::SynapsisEffect(int index, Interconnection * InputConnection){
...
double TableBasedModelHF::NextFiringPrediction(int index, VectorNeuronState * State){
	return this->FiringTable->TableAccess(index, State);
}

double TableBasedModelHF::EndRefractoryPeriod(int index, VectorNeuronState * State){
...
InternalSpike * TableBasedModelHF::ProcessActivityAndPredictSpike(Neuron * target){
...
InternalSpike * TableBasedModelHF::GenerateNextSpike(InternalSpike *  OutputSpike){
...
bool TableBasedModelHF::DiscardSpike(InternalSpike *  OutputSpike){
...
ostream & TableBasedModelHF::PrintInfo(ostream & out) {
