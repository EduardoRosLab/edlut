 ...
 * \date October 2012
 *
 * This file declares a class which implement a auto-adaptative variable step integration method based on a 1º order 
 * BDF (Backward Differentiation Formulas) mehtod. 
 */
 ...
 * \class BDF1ad
 *
 * \brief BDF1ad integration methods
 *
 * This class implement the behavior of a auto-adaptative variable step integration method based on a 1º order BDF method for 
 * neurons in a time-driven spiking neural network.
...
class BDF1ad : public VariableStep {
	...
	public:
		...
		/*!
		 * \brief This object implements a variable step integration method based on a 1º order DBF method.
		*/
		BDF1vs * BDF;
		...
		*/	
		...
		/*!
		 * \brief Auxiliar neuron state vector used by the BDF1vs object to predict the future neuron state for each
		 * neuron associated to this integration mehtod.
		*/
		float * PredictedNeuronState;
		
		/*!
		 * \brief This vector control the prediction validity made in PredicteNeuronState by the BDF1vs
		...
		*/
		...
		/*!
		 * \brief This vector contains the future integration step size that whould be used for each neuron associated 
		 * to this integration method.
		*/
		 ...
		 *
		 * It generates a new BDF1ad object.
		 *
		 ...
		 */
		BDF1ad(TimeDrivenNeuronModel * NewModel, int N_neuronStateVariables, int N_differentialNeuronState, int N_timeDependentNeuronState);
