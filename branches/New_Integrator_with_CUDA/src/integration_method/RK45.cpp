...
RK45::RK45(int N_neuronStateVariables, int N_differentialNeuronState, int N_timeDependentNeuronState, int N_CPU_thread):FixedStep("RK45", N_neuronStateVariables, N_differentialNeuronState, N_timeDependentNeuronState, N_CPU_thread, false, false),
	a1(25.0/216.0), a2(0), a3(1408.0/2565.0), a4(2197.0/4104.0), a5(-0.2),
	b1(16.0/135.0), b2(0), b3(6656.0/12825.0), b4(28561.0/56430.0), b5(-0.18), b6(2.0/55.0),
	c20(0.25), c21(0.25),
	...
	c60(0.5), c61(-8.0/27.0), c62(2), c63(-3544.0/2565.0), c64(1859.0/4104.0), c65(-0.275)
{	
...
void RK45::NextDifferentialEcuationValue(int index, TimeDrivenNeuronModel * Model, float * NeuronState, double elapsed_time, int CPU_thread_index){
