...
class NeuronModelTable {
	...
	public:
		...
		/*!
  		 * \brief It gets the owner neuron type.
  		 * 
  		 * It gets the type owning this neuron model table.
  		 * 
  		 * \return The neuron type.
  		 */
  		const NeuronType * GetOwnerType() const;
  		
  		/*!
  		 * \brief It sets the owner type.
  		 * 
  		 * It sets the neuron type owning this neuron model table.
  		 * 
		 * \param The owner neuron type.
  		 */
  		void SetOwnerType(NeuronType * Owner);
	...
	private:
		...
		/*!
		 * Neuron type owning this neuron table
		 */
		NeuronType * OwnerType;
		...
		/*!
   		 * \brief It gets a table value with direct interpolation.
		 * 
   		 * It gets a table value with direct interpolation with concrete state variables.
   		 * 
   		 * \param statevars State variables of the neuron.
		 * 
   		 * \return The table value with that state.
